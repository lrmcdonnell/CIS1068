...
public class ArrayPracticeTest {
	...
	public void testIsOdd() {
		...
		assertTrue(ArrayPractice.isOdd(559));
		assertFalse(ArrayPractice.isOdd(0));
		assertFalse(ArrayPractice.isOdd(-4));
		assertFalse(ArrayPractice.isOdd(8792));
	}
	 ...
	 */
	 ...
	 public void testGetCol() {
		 ...
		 int [] C = {11,12,13};
		 int [] D = {1,2,3};
		 assertArrayEquals((ArrayPractice.getCol(A2D, 0)), B);
		 assertArrayEquals((ArrayPractice.getCol(A2D, 1)), C);
		 assertArrayEquals((ArrayPractice.getCol(A2D, 2)), D);
