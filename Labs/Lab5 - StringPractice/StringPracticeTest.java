...
class StringPracticeTest extends StringPractice {
  ...
  void testNumPunctAfterNonPunct() {
    ...
    assertEquals(0, StringPractice.numPunctAfterNonPunct("!!"));
    assertEquals(0, StringPractice.numPunctAfterNonPunct("!!?? "));
    assertEquals(1, StringPractice.numPunctAfterNonPunct(" !!"));
    assertEquals(1, StringPractice.numPunctAfterNonPunct("hi!"));
    assertEquals(1, StringPractice.numPunctAfterNonPunct("cheesy poofs."));
    assertEquals(2, StringPractice.numPunctAfterNonPunct("foo, bar!"));
    assertEquals(2, StringPractice.numPunctAfterNonPunct("foo ? baz!"));
    assertEquals(2, StringPractice.numPunctAfterNonPunct("???? ?? ?"));
    assertEquals(3, StringPractice.numPunctAfterNonPunct("foo. bar. baz."));
    assertEquals(4, StringPractice.numPunctAfterNonPunct("foo ? foo ! bar. baz;"));
